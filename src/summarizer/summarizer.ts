...
# 弊社について
弊社は日本最大級のクリエイターコミュニティ（延べ450万人超のフォロワー）を運営し、信頼されたキュレーションとブランドセーフティを強みとする企業です。主なクライアントはカメラメーカー、官公庁、自治体で、地方創生やプロモーションに強みを持っています。

# 主要な役職と注目すべき観点
## 1. 企画営業職マネージャー
弊社の「信頼資本」と「ブランドセーフティ」をクライアントに提供し、収益の安定化を図る立場。
...
## 3. マーケティングマネージャー
弊社のソリューションを市場に浸透させ、特に強みを持つニッチ領域の専門性を訴求する責任者。
